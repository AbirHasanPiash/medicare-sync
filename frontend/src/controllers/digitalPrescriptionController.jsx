...
export const downloadPatientPrescriptionPdf = async ({
  api,
  appointmentId,
}) => {
  if (!appointmentId) {
    throw new Error('Invalid appointment for prescription download.');
  }

  const response = await api.get(
    `/patient-prescriptions/${appointmentId}/download`,
    {
      responseType: 'blob',
    }
  );
